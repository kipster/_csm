...
*/
  ...
  // Fetch the fidelity points for this order:
    $check_fidelity_query = tep_db_query("select fidelity from " . TABLE_ORDERS . " where orders_id = '" . (int)$order_id . "'");
...
<?php
  ...
  while ($statuses = tep_db_fetch_array($statuses_query)) {
    echo '              <tr>' . "\n" .
         '                <td class="main" valign="top" width="29%">' . tep_date_short($statuses['date_added']) . '</td>' . "\n" .
         '                <td class="main" valign="top" width="40%">' . $statuses['orders_status_name'] . '</td>' . "\n" .
...
?>
      ...
      <tr>
        <td class="smallText"><p><?php echo $fidelity; ?></p>
        </td>
      </tr>
<?php
