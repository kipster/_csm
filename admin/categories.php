          ...
          <tr>
            ...
            <td><table border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td class="main"><a href="javascript:;" onmousedown="tinyMCE.get('wp').show();">[Editeur de texte]</a>
		<a href="javascript:;" onmousedown="tinyMCE.get('wp').hide();">[Language Magique]</a><br>
        <?php echo tep_draw_textarea_field('products_description[' . $languages[$i]['id'] . ']', 'soft', '70', '50', (isset($products_description[$languages[$i]['id']]) ? stripslashes($products_description[$languages[$i]['id']]) : tep_get_products_description($pInfo->products_id, $languages[$i]['id']))); ?><br><br>
                                    <!-- Some integration calls -->
		<a href="javascript:;" onmousedown="tinyMCE.get('wp').show();">[Editeur de texte]</a>
		<a href="javascript:;" onmousedown="tinyMCE.get('wp').hide();">[Language Magique]</a></td>
              </tr>
            </table></td>
          </tr>
<?php
