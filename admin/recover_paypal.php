...
if ($action == del){
    $delete = "DELETE FROM `customers_basket_backup` WHERE `customers_id` = '$id'";
    $run = mysql_query($delete);
    echo 'Panier effac&eacute; <a href="customers.php">Retour</a>';
    }
...
<a href="?action=del&cID=<?php echo $id ?>">Vider le panier temporaire paypal</a>
