<?php
header("Location: my_tools.php?selected_box=my_tools");
/*
...
/*  require('includes/application_top.php');
  ...
  $cat = array(array('title' => BOX_HEADING_CONFIGURATION,
               ...
               array('title' => BOX_HEADING_MT,
                     'image' => 'tools.gif',
                     'href' => tep_href_link(FILENAME_MT, 'selected_box=my_tools'),
                     'children' => array(array('title' => BOX_MT_WP, 'link' => tep_href_link(FILENAME_MT_WP, 'selected_box=my_tools')),
                                         array('title' => BOX_MT_UP, 'link' => tep_href_link(FILENAME_MT_UP, 'selected_box=my_tools')),
                                         array('title' => BOX_MT_CUSTOMERS, 'link' => tep_href_link(FILENAME_MT_CUSTOMER, 'selected_box=my_tools')),
                                         array('title' => BOX_MT_NEWS, 'link' => tep_href_link(FILENAME_MT_NEWS, 'selected_box=my_tools')))));
...
<?php
  ...
  $contents[] = array('params' => 'class="infoBox"',
                      'text'  => '<a href="http://www.oscommerce.com" target="_blank">' . BOX_ENTRY_SUPPORT_SITE . '</a><br>' .
                                 '<a href="http://www.oscommerce.com/community/contributions" target="_blank">' . BOX_ENTRY_CONTRIBUTIONS . '</a><br>' .
                                 '<a href="' . BOX_LINK_SUPPORT_FORUMS . '" target="_blank">' . BOX_ENTRY_SUPPORT_FORUMS . '</a>');
if ($language=="french") {
  $contents[] = array('params' => 'class="infoBox"',
                      'text'  => '<a href="http://www.oscommerce-fr.info" target="_blank">' . BOX_ENTRY_INFORMATION_PORTAL . '</a><br>' .
                                 '<a href="http://www.oscommerce-fr.info/faq/" target="_blank">' . BOX_ENTRY_FAQ . '</a>' );
}
  $box = new box;
