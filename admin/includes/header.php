...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr class="headerBar">
    <td class="headerBarContent">&nbsp;&nbsp;<?php echo '<a href="' . tep_href_link(FILENAME_DEFAULT, '', 'NONSSL') . '" class="headerLink">' . HEADER_TITLE_TOP . '</a> - <a class="headerLink" href="orders.php">Commande</a> - <a class="headerLink" href="customers.php">Clients</a> - <a class="headerLink" href="mt_welcome_page.php">Changer accueil</a> - <a class="headerLink" href="mt_newsletter.php">Envoyer newsletter</a> - <a class="headerLink" href="mt_fidelity.php">Points fidelite</a> - <a class="headerLink" href="categories.php">Ajouter un article</a>'; ?></td>
