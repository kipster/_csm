...
define('ENTRY_NEWSLETTER_NO', 'Non abonn&eacute;');
...
define('TEXT_DISPLAY_NUMBER_OF_NEWSLETTERS', 'Affiche <b>%d</b> &agrave; <b>%d</b> (sur <b>%d</b> bulletins d\'informations)');
define('TEXT_DISPLAY_NUMBER_OF_ORDERS', 'Affiche <b>%d</b> &agrave; <b>%d</b> (sur <b>%d</b> commandes)');
define('TEXT_DISPLAY_NUMBER_OF_ORDERS_STATUS', 'Affiche <b>%d</b> &agrave; <b>%d</b> (sur <b>%d</b> statuts commandes)');
...
// My_tools box:
define('BOX_HEADING_MT', 'Perso');
define('BOX_MT_WP', 'Modifier l\'accueil');
define('BOX_MT_NEWS', 'Email News');
define('BOX_MT_CUSTOMERS', 'Email Client News');
define('BOX_MT_UP', 'Photo pour galerie');
define('BOX_MT_2009_12', 'Super challenge');
