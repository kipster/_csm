...
<!-- body_text //-->
    <td width="100%" valign="top">
        <h1>Voici l'email des clients non-enregistr&eacute;s qui veulent recevoir la lettre de nouvelle.</h1><br>
        ...
        while($row = mysql_fetch_assoc($result))
            {
                $var1 = "{$row['customers_email_address']}";
                
                $delete = "DELETE FROM `customers_news` WHERE CONVERT( `email` USING utf8 ) = '$var1' LIMIT 1";
