...
// define the filenames used in the project
  ...
  define('FILENAME_RESPONSE', 'sendmailresponse.php');
  ...
  define('FILENAME_VIDEO', 'video.php');
  define('FILENAME_Z_FILE', 'z_file_perfect_exemple.php');
?>
