...
// class methods
    ...
    function process_button() {
      ...
      //backup the cart incase user clears it after payment with paypal
      //We want the cart incase customer does not return back from paypal
     tep_db_query("DELETE FROM customers_basket_backup where customers_id = " . $customer_id );
     tep_db_query("INSERT INTO customers_basket_backup (customers_basket_id,customers_id,products_id,customers_basket_quantity,final_price,customers_basket_date_added) select customers_basket_id,customers_id,products_id,customers_basket_quantity,final_price,customers_basket_date_added from customers_basket where customers_id = " . $customer_id );
