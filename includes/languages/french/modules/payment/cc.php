...
*/
  ...
  define('MODULE_PAYMENT_CC_TEXT_JS_CC_NUMBER', '* Le numéro de la carte de crédit doit avoir au moins ' . CC_NUMBER_MIN_LENGTH . ' caractères.\n');
  define('MODULE_PAYMENT_CC_TEXT_ERROR', 'Erreur carte de crédit !');
?>
