...
*/
  ...
  define('MODULE_PAYMENT_2CHECKOUT_TEXT_JS_CC_NUMBER', '* Le numéro de la carte de crédit doit avoir au moins ' . CC_NUMBER_MIN_LENGTH . ' caractères.\n');
  define('MODULE_PAYMENT_2CHECKOUT_TEXT_ERROR_MESSAGE', 'Il y a eu une erreur lors de la validation de votre carte. Merci de bien vouloir recommencer.');
