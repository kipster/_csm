...
<!-- body_text for categories query//-->
<?php
...
// check to see if there are deeper categories within the current category
    ...
    while ($categories = tep_db_fetch_array($categories_query)) {
      ...
      echo '                <td align="center" class="smallText" width="' . $width . '" valign="center"><a class="smallText" href="' . tep_href_link(FILENAME_DEFAULT, $cPath_new) . '"><p>' . $categories['categories_name'] . '</p>' . tep_image(DIR_WS_IMAGES . $categories['categories_image'], $categories['categories_name'], SUBCATEGORY_IMAGE_WIDTH, SUBCATEGORY_IMAGE_HEIGHT) . '</a></td>' . "\n";
