...
*/
  ...
  $points_query = tep_db_query("select points from " . TABLE_CUSTOMERS . " where customers_id = '" . (int)$customer_id . "'");
...
?>
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main"><b>Mes points de fid&eacute;lit&eacute;.</td>
          </tr>
        </table></td>
      </tr>
      <tr>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="main"><?php echo tep_image(DIR_WS_IMAGES . 'arrow_green.gif') . '<span class="purple">Vous avez <b>' . $pr . '</b> points de fid&eacute;lit&eacute;, soit l\'&eacute;quivalent d\'un bon d\'achat sur notre site de <b>' .  $value . '</b> euros.<br>
                    Vous pouvez les d&eacute;penser en selectionant l\'option appropri&eacute; lors de votre paiement.</span>'; ?></td>
                  </tr>
                </table></td>
